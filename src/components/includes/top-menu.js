  ...
  render() {
    return <div className="topMenu" id="topMenu">
      ...
      <div className="menuRight">
        <div className="authBtn" onClick={() => {this.props.modalMethods(); this.props.setAuth()}}>Авторизация</div>
        <div className="verticalLine"></div>
        <div className="authBtn" onClick={() => {this.props.modalMethods(); this.props.setRegister()}}>Регистрация</div>
      </div>
